...
% This is an example file on how to plot two function:
%     V1 = exp^(-at)
% and 
%     V2 = exp^(-at) * cos(wt - 90 degrees)
% on both a linear and semi-logarithmic graph
%
% To complete the Post-Lab Part A of Lab 1, you will need to replace the 
% functions V1 and V2 below, with the equations you derived in lab. 

%% Clear variables and define new variables
